#SE577 Group 1 ~ Microservices: Order

# Train Sim

An application to simulate purchasing train tickets for SE577 Group Homework Assignment 2.

This call is provided for order:
1) http://localhost:8004/api/order/checkout to place an order
...
#### Debugging trainsim-order-service
